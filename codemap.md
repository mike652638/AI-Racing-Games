...
| `src/game/`    | 游戏编排层：GameLoop 编排壳 + 纯函数下沉件（mode-strategy 策略对象/frame-update/frame-render/frame-pure/finish-accounting/collision-feedback 红闪状态机/audio-rig/countdown/dom-setup/track-preview，M34 起 + game-params/menu-setup/route-choice/boost-feedback/track-cards/pause-controls）、双玩家 TrackContext 赛道世界、RaceState、阶段 FSM 兼容层、挑战模式/热座/分屏支持 | [src/game/codemap.md](src/game/codemap.md)       |
