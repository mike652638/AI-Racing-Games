...
export const TRACK_DEFS: TrackDef[] = [
  ...
  { id: 'canyon', name: '峡谷疾驰', difficulty: 3, controlPoints: CANYON_CONTROL_POINTS, laps: 2, trafficCount: 8 },
  ...
  { id: 'alpine', name: '山岳险道', difficulty: 3, controlPoints: ALPINE_CONTROL_POINTS, laps: 2, trafficCount: 6 },
]
